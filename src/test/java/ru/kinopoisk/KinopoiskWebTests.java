...
public class KinopoiskWebTests extends TestBase {
    ...
    @CsvSource({
            "fdfdfadgsfhsfhshsghsgsghsgh, Нет такого аккаунта. Проверьте логин или войдите по телефону",
            "екерврп, Такой логин не подойдет"
    })
    @ParameterizedTest
    ...
    void wrongAuthorization(String login, String expectedError) {
       ...
       // $(".Textinput-Hint_state_error").shouldHave();
    }
    @ValueSource(strings = {
            "Форсаж",
            "Такси"
